<template>
      ...
      <div v-else class="quiz-container">
        ...
        <div class="question-container">
          <div class="question-content">
            ...
            <div v-if="currentQuestion.image_paths && currentQuestion.image_paths.length" class="question-images">
              <img 
                v-for="(image, index) in currentQuestion.image_paths" 
                :key="index" 
                :src="image" 
  ...
  export default {
    ...
    computed: {
      ...
      formattedAnswer() {
        return marked(this.correctAnswer || '');
      },
      scorePercentage() {
