  ...
  try {
    ...
    for (const original of questions) {
      const item = {
        ...
        answer_key: typeof original.answer_key === 'object' && original.answer_key !== null
          ? { ...original.answer_key, correct_answer: escapeLatex(original.answer_key.correct_answer) }
          : original.answer_key,
